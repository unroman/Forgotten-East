...
public class ModBlocks {
    ...
    public static RegistryObject<Block> ROOF_TILES = register(() -> new Block(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS)), "roof_tiles");
    ...
    public static RegistryObject<Block> ROOF_TILES_STAIRS = register(() -> new StairBlock(ROOF_TILES.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.STONE_BRICK_STAIRS)), "roof_tiles_stairs");
    public static RegistryObject<Block> ROOF_TILES_SLAB = register(() -> new RoofSlabBlock(BlockBehaviour.Properties.copy(Blocks.STONE_BRICK_SLAB)), "roof_tiles_slab");
    public static RegistryObject<Block> PAPER_LANTERN_RED = register(() -> new PaperLanternBlock(BlockBehaviour.Properties.of().mapColor(MapColor.WOOL).forceSolidOn().strength(3.0F).sound(SoundType.WOOL).lightLevel((p_152677_) -> {return 15;}).noOcclusion().pushReaction(PushReaction.DESTROY)), "paper_lantern_red");
    public static RegistryObject<Block> PAPER_LANTERN_WHITE = register(() -> new PaperLanternBlock(BlockBehaviour.Properties.copy(PAPER_LANTERN_RED.get())), "paper_lantern_white");
    public static RegistryObject<Block> PAPER_LANTERN_BLACK = register(() -> new PaperLanternBlock(BlockBehaviour.Properties.copy(PAPER_LANTERN_RED.get())), "paper_lantern_black");
    public static RegistryObject<Block> DRAGON_BLOCK = register(() -> new DragonBlock(BlockBehaviour.Properties.copy(Blocks.STONE_BRICKS)), "dragon_trap");
